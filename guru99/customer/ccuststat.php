...
<body>
    ...
    <!-- <?php require '..\components\cust.css' ?> -->
...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    if($result3!==FALSE && mysqli_num_rows($result3) > 0){
        $sql="SELECT * FROM `c_account` WHERE `sno`='$sno' AND `c_id`='$_userid'";
        ...
        $showError= "The Customer UserId or Password is incorrect, please try again.";
